...
# Wald Test for Statistical significance of coefficients
library(survey)
regTermTest(m, "n_word")
regTermTest(m, "rho_conc")
regTermTest(m, "LexAmbigSent")
regTermTest(m, "SynAmbigSent")

regTermTest(m_trim, "n_word")
regTermTest(m_trim, "LexAmbigSent")
